...
<main role="main">
 ...
 <section class="jumbotron text-center">
    <div class="container">
      ...
      <p class="lead text-muted" id="current_showing">Currently showing: Published</p>
      <p class="lead text-muted" id="ratings"></p>
      <p>
      	<button class="btn btn-primary my-2" id="published_button">Published</button>
		<button class="btn btn-primary my-2" id="reviews_button">Reviews</button>		
...
<div class="container" id="deal_list" align="center">
	<h4 align="center" id="no_deals_message">No deals to show.</h4>
