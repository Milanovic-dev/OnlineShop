...
<nav class="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
  ...
  <button type="button" class="btn btn-secondary"  data-toggle="modal" data-target="#user_modal_update" id="admin_update_button">Update Role</button>
  <button type="button" class="btn btn-secondary"  data-toggle="modal" data-target="#user_modal_filter" id="filter_button">Filter</button>
</div>
</form>

<div class="modal" tabindex="-1" role="dialog" id="user_modal_update">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group">
  			<select class="form-control" id="user_role_select">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary" data-dismiss="modal" id="update_role_button">Update</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal" tabindex="-1" role="dialog" id="user_modal_filter">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Filtered Search</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      ...
      <div class="input-group mb-3">
  			<input type="text" class="form-control" placeholder="Name" aria-label="Name" id="filter_name">
		</div>
		<div class="form-group">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button type="button" class="btn btn-primary" data-dismiss="modal" id="filter_apply_button">Apply</button>
      </div>
    </div>
  </div>
</div>
